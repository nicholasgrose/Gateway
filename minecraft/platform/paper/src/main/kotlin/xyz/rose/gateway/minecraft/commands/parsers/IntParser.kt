package xyz.rose.gateway.minecraft.commands.parsers
 ...
 */
fun <A> CommandArgs<A>.int(body: IntParserBuilder<A>.() -> Unit): IntParser<A> where A : CommandArgs<A> =
 ...
 */
class IntParser<A : CommandArgs<A>>(
    builder: IntParserBuilder<A>,
